...
namespace LotkaVolterraOdeSimulation
{
      ...
      {
            private List<double> preys = new List<double>();
            private List<double> predators = new List<double>();
            public int[] iteration = new int[100];
            public bool isCalculationDone = false;
...
*/                        /*System.Diagnostics.Process.Start("./pry.txt");*/
            ...
            public List<double> LVPreyOde()
            {

                  return preys;
            }

            public List<double> LVPredatorOde()
            {
